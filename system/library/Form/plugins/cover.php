<?php
    ...
    function form_cover($name, $value, $parameters, $validation, $cp) {
        ...
        $cover_html = '<a href="' . ( UPLOADS_DIR . $cover ) . '" rel="lightbox"><img src="' . ( UPLOADS_DIR . $cover_thumbnail ) . '" alt="cover"/></a> <img src="' . ADMIN_VIEWS_IMAGES_URL . 'del.gif" style="cursor:hand" onclick="cover_delete(\'' . $content_id . '\', \'' . $script_dir . '\');" alt="delete"/>';
        ...
        return '<div id="cover">' . ( $value ? $cover_html : $iframe_html ) . '</div>';
    }
