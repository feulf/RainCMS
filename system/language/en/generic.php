<?php
    ...
    //Time (time_format function)
    define("DATE_FORMAT", "%b %d %Y");
    define("DATE_TIME_FORMAT", "%D - %I:%M %p");
    define("TIME_FORMAT", "%I:%M %p");
    define("MONTH_FORMAT", "%b %d");

    // Timestamp to date for datepicker (use %d-%m-%Y for european date)
    define("DATE_FORMAT_SIMPLE", "%m/%d/%Y");

    // Datepicker date format (use dd-mm-yy for european date)
    define("SDATE_FORMAT", "mm/dd/yy");
